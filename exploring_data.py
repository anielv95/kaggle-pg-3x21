...
train["target_cat"] = pd.cut(train["target"],
                               bins=[0., 4.0, 8.0, 12.0, 16.0, np.inf],
                               labels=[1, 2, 3, 4, 5])
...
strat_train_set.to_csv("/gh/kaggle-pg-3x21/kaggle-pg-3x21/data/strattified_data.csv",index=False)